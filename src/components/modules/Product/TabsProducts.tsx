...
import { TProductSchema, TShipping } from "@/utils/types";
...
export default function TabsProducts({
  ...
  return (
    <div className="w-full space-y-4">
      ...
      {tab == 0 && <TabDescription product={product} />}
      {tab == 1 && <TabMeasurements measurements={product.measurements} />}
      {tab == 2 && <TabShipping shipping={shipping} />}
    </div>
  );
}
